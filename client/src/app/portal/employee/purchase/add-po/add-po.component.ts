...
generatePDF() {
  ...
  const documentDefinition: TDocumentDefinitions = {
    content: [
      ...
      {
        text: 'We are pleased to confirm our purchase order as per the details below:',
        style: 'bodyText',
        margin: [0, 0, 0, 20]
      },
      {
      ...
      {
        text: 'We look forward to your prompt acknowledgment and confirmation of this order.',
        style: 'bodyText'
      }
    ],
    styles: {
